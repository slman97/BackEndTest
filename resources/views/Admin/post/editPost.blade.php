...
<div class="container">
    ...
    <form action="/admin/post/{{$post->id}}/update" class="form-stl" name="frm-login" method="post">
        @csrf
        @method('PATCH')
       
            <h3 class="col-md-4 col-form-label text-md-end" >Edit POst Information</h3>
           ...
           <strong style="color : red">{{ $message }}</strong>
             ...
             <br>
                <div class="row pt-4">
                    ...
                    <button class="btn-primary col-md-2 col-form-label text-md-end"> {{__('Save post')}} </button>
                </div>
    </form>
</div>
@endsection